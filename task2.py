...
bushesNumbers = int(input('Введите кол-во кустов: '))
berries = [int(i) for i in input('Кол-во ягод на каждом из кустов: ').split()]
maxBerries = 0

for i in range(bushesNumbers):
    sumBerries = berries[i - 1] + berries[i] + berries[i + 1 if i < bushesNumbers - 1 else 0]
